    ...
    ["Taco Bell", 1.1,
        {
            ...
            "Quesadilla":5.79,
            "Nachos":2.59
        }, 4.3, "taco-bell.jpeg", "Mexican Food", "710 3rd Street, San Francisco, CA", "An American multinational chain of fast food restaurants."
    ],
    ["Trader Joe's", 0.2, 
        {
            "Burger": 6.99,
        ...
        4.5, "trader-joes.png", "Grocery Store", "10 4th Street, San Francisco, CA", "Popular Grocery Store in the US."
    ],
    ["Safeway", 1.2,
        {
            "Burger": 25.99,
        ...
        3.9, "safeway.png", "Grocery Store", "298 King Street, San Francisco, CA", "Popular Grocery store in the US."
    ],
    ["Costco", 1.2,
        {
        ...
        4.4, "costco.png", "Grocery Store", "450 10th Street, San Francisco, CA", "Sells objects in large quantities, resulting in low price, high quantity."
    ]
]
...
async function search(restaurants, desired_food) {
    ...
    for(var i = 0; i < names.length; i++){
        ...
        place.setAttribute("onclick", "openRe(" + i + ")")
